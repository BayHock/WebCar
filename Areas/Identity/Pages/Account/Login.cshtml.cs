...
namespace WebCar.Areas.Identity.Pages.Account
{
	public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<WebCarUser> signInManager, ILogger<LoginModel> logger, UserManager<WebCarUser> userManager)
        {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            returnUrl ??= Url.Content("~/Welcome/WelcomeAuthUser");
